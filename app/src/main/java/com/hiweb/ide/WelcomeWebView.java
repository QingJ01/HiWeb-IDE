...
public class WelcomeWebView extends WebView 
{
    ...
    public WelcomeWebView(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr, int defStyleRes) 
    {
    ...
    private void init()
    {
		...
		setWebChromeClient(new WebChromeClient(){
				public boolean onJsAlert(android.webkit.WebView view, java.lang.String url, final java.lang.String message, android.webkit.JsResult result) 
				{
					...
					try
					{
						for(int i=0;i<vJaOpenedFiles.size();i++)
						{
							...
							if(isStar)
							{
								...
								{
									int IOpenSID=Do.getMFileKey((HashMap<Integer,File>)MainActivity.main.binding.Ep.MAllFiles,file);
    ...
    public class EasyWeb
    {
        ...
        {
            Do.showImgDialog(getContext(),R.string.server_import_help_title,R.string.server_import_help_msg,R.drawable.server_help);
        }
		@JavascriptInterface
		...
		public void setExp()
		{
			final String url="https://gloriouspast.gitee.io/server/easyweb/example/newest.html";
			MainActivity.main.runOnUiThread(new Runnable(){
						...
						vWv.setWebChromeClient(new WebChromeClient(){
								...
								public boolean onJsAlert(android.webkit.WebView view, java.lang.String url, final java.lang.String message, android.webkit.JsResult result) 
								{
									WelcomeWebView.this.post(new Runnable(){
											...
											public void run()
											{
												WelcomeWebView.this.evaluateJavascript("javascript:addExp('"+message.split("<thenext>")[0]+"','"+message.split("<thenext>")[1]+"','"+message.split("<thenext>")[2]+"')",null);
											}
										});
									result.confirm();
									return true;
