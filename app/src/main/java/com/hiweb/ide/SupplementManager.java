...
public class SupplementManager {
	public static void show() {
		...
		LvPacked.setAdapter(new ArrayAdapter(MainActivity.main, android.R.layout.simple_list_item_1,
				new String[] { MainActivity.main.getString(R.string.supplement_rules_packed) }));
		LvDIY.setAdapter(new ArrayAdapter(MainActivity.main, android.R.layout.simple_list_item_1,
				new String[] { MainActivity.main.getString(R.string.supplement_rules_diy) }));
