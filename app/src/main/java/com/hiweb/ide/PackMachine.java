...
public class PackMachine {
    ...
    public void show(boolean isCreatingProj) {
        if (isCreatingProj) isAllowEasyApp = true;
        try {
            if (checkAndDownload()) {
                    ...
                    try {
                        ...
                        MainActivity.main.runOnUiThread(() -> {
                                ...
                                try{
                                    ...
                                    iv.setLayoutParams(new LinearLayout.LayoutParams(Do.dp2px(MainActivity.main, 50), Do.dp2px(MainActivity.main, 50)));
                                    if (iconPath==null||!new File(iconPath).exists()) {
                                        Do.copySdcardFile(icon.getPath(), favicon.getPath());
                                        iconPath =null;
                                    }

                                    Bitmap bitmap = BitmapFactory.decodeFile(iconPath==null ? favicon.getPath() : iconPath);
                                        ...
                                        fileChooseClass.setOnFileClickListener(new OnFileClickListener() {
                                            ...
                                            public void onClick(File ChooseFile, AlertDialog dialog) {
                                                if (ChooseFile.getName().toLowerCase().endsWith(".png")) {
                                                    if(!ChooseFile.getPath().startsWith(Vers.i.ProjectDir.getPath()))
                                                    {
                                                        ...
                                                        dl.builder
                                                                ...
                                                                .setPositiveButton(R.string.yes, (dialog1, which) -> {
                                                                    File projIcon=new File(Vers.i.ProjectDir,ChooseFile.getName());
                                                                    try {
                                                                        Do.copySdcardFile(ChooseFile.getPath(),projIcon.getPath());
                                                                        MainActivity.main.binding.elvMainExplorerFile.toExplorer(new File(Vers.i.ProjectDir+ Vers.i.ExplorerPath));
                                                                        Bitmap bitmap1 = BitmapFactory.decodeFile(projIcon.getPath());
                                                                        dialog.dismiss();
                                                    ...
                                                    Toast.makeText(MainActivity.main, R.string.pack_apk_choose_icon, Toast.LENGTH_SHORT).show();
                                                    return;
                                                }
                                            }
                                        });
                                    ...
                                    lySet.setPadding(Do.dp2px(MainActivity.main, 10), Do.dp2px(MainActivity.main, 10), Do.dp2px(MainActivity.main, 10), Do.dp2px(MainActivity.main, 10));
                                    ly.addView(lySet);
                                    ...
                                    ad.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(p1 -> {
                                        ...
                                        if (name == null || packname == null || versionName == null || versionCode == null) {
                                    ...
                                    ad.getButton(AlertDialog.BUTTON_NEGATIVE).setOnClickListener(p1 -> {
                                        ...
                                        dlAsk.builder
                                                ...
                                                .setPositiveButton(R.string.ok, (dialog, which) -> {
                                                    String config=getManifestText(name,packname,versionName,versionCode);
                                                    try {
                                                        makeAPKEasyweb=new File(Vers.i.ProjectDir,"MakeAPK.easyweb");
                                                        makeAPKEasyweb.createNewFile();
                                                        Do.write(config,makeAPKEasyweb);
                                                        MainActivity.main.binding.elvMainExplorerFile.toExplorer(new File(Vers.i.ProjectDir+ Vers.i.ExplorerPath));
                                                        new Dl(MainActivity.main,R.string.done,R.string.save_config_successfully,R.string.ok);
                                                    } catch (IOException e) {
                                                        MainActivity.main.toast(R.string.error);
                                                    }
                                    ...
                                    ad.getButton(AlertDialog.BUTTON_NEUTRAL).setOnClickListener(p1 -> {
                                        ...
                                        visibleCl.build(false, -1, null, R.string.titlebar_visible, MainActivity.main.getString(R.string.enable) + "|" + MainActivity.main.getString(R.string.disable));
                                        ...
                                        longCliclCl.build(false, -1, null, R.string.long_onclick, MainActivity.main.getString(R.string.enable) + "|" + MainActivity.main.getString(R.string.disable));
                                        ...
                                        waitCl.build(false, -1, null, R.string.show_wait_dialog, MainActivity.main.getString(R.string.enable) + "|" + MainActivity.main.getString(R.string.disable));
                                        waitCl.Acs.setSelection(isShowWait ? 0 : 1, false);
                                        Ly.addView(waitCl);
                                        final ChoiceLayout allowZoomCl = new ChoiceLayout(MainActivity.main);
                                        allowZoomCl.build(false, -1, null, R.string.allow_zoom, MainActivity.main.getString(R.string.enable) + "|" + MainActivity.main.getString(R.string.disable));
                                        ...
                                        zoomAsPCCl.build(false, -1, null, R.string.zoom_as_pc, MainActivity.main.getString(R.string.enable) + "|" + MainActivity.main.getString(R.string.disable));
                                        ...
                                        allowJSAppActionsCl.build(false, -1, MainActivity.main.getString(R.string.allow_easyapps), R.string.allow_easyapps_description, MainActivity.main.getString(R.string.enable) + "|" + MainActivity.main.getString(R.string.disable));
                                        allowJSAppActionsCl.Acs.setSelection(isAllowEasyApp ? 0 : 1, false);
                                        Button jsAppActionsInfBtn=new Button(MainActivity.main,null,R.attr.buttonBarButtonStyle);
                                        ...
                                        dl1.builder.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface p1, int p2) {
                                                ...
                                                titlebarColor = color;
                                                titlebarVisible = visibleCl.getText("$").equals(MainActivity.main.getString(R.string.disable));
                                                isLongClick = longCliclCl.getText("$").equals(MainActivity.main.getString(R.string.enable));
                                                isShowWait = waitCl.getText("$").equals(MainActivity.main.getString(R.string.enable));
                                                isAllowZoom = allowZoomCl.getText("$").equals(MainActivity.main.getString(R.string.enable));
                                                isZoomAsPC = zoomAsPCCl.getText("$").equals(MainActivity.main.getString(R.string.enable));
                                                isAllowEasyApp = allowJSAppActionsCl.getText("$").equals(MainActivity.main.getString(R.string.enable));
                                            }
                                        });
                                        dl1.show();
                                    });
        ...
        dl.builder.setPositiveButton(R.string.download, (p1, p2) -> Do.showWaitAndRunInThread(true, new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    packDir.mkdirs();
                    Do.downloadNet(Vers.i.serverHost + "server/easyweb/easyapp/packLib.zip", packLibZip.getPath());
                    packLibDir.mkdirs();
                    ...
                    MainActivity.main.runOnUiThread(() -> {
                        ...
                        dlDone.builder.setPositiveButton(R.string.ok, null);
                        dlDone.builder.setNeutralButton(R.string.solve_proj, (p11, p21) -> Do.openUrl(Vers.i.supportHost + "easywebide/article/#6", MainActivity.main));
                        dlDone.show();
                    });
                }
            }
    ...
    private String getManifestText(String name,String pack,String versionName,String versionCode)
    {
        ...
        baseConfig.addProperty("icon",iconPath == null ? null : Do.getRelativePath(makeAPKEasyweb.getPath(),iconPath));
            ...
            Do.showWaitAndRunInThread(false, () -> {
                try {
                    ...
                    if(!apk.exists()){
                        Do.finishWaiting();
                        MainActivity.main.runOnUiThread(()->{
                            new Dl(MainActivity.main,MainActivity.main.getString(R.string.error_msg),aaptMsg,MainActivity.main.getString(R.string.ok));
                        });
                        return;
                    }
