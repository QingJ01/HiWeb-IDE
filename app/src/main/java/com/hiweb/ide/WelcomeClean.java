...
public class WelcomeClean {
	public static void update() {
		...
		ly.setPadding(Do.dp2px(MainActivity.main, 30), Do.dp2px(MainActivity.main, 30), Do.dp2px(MainActivity.main, 30),
				0);
		...
		if (Vers.i.vOaBackup != null) {
			FeedButton recoverBtn = new FeedButton(MainActivity.main, R.string.recover_msg, -1,
					MainActivity.main.getDrawable(R.drawable.recover));
			...
			recoverBtn.setOnClickListener(view -> {
				...
				dl.builder.setMessage(MainActivity.main.getString(R.string.recover_1) + " " + Vers.i.vOaBackup[0] + " "
						+ MainActivity.main.getString(R.string.recover_2));
		...
		if (Vers.i.isAutoStartPHPServer) {
			FeedButton phpBtn = new FeedButton(MainActivity.main, R.string.php_web_server_has_recovered, -1,
					MainActivity.main.getDrawable(R.drawable.link));
		...
		if (!Vers.i.isInstalledHopWeb && !new TipsManager(MainActivity.main).isExists("learn_hopweb")) {
			FeedButton hwadBtn = new FeedButton(MainActivity.main, R.string.get_hopweb_ad, -1,
					MainActivity.main.getDrawable(R.drawable.hopweb_line));
		...
		if (AnnouncementManager.isNeedAnnouncing(MainActivity.main)) {
			FeedButton announcementBtn = new FeedButton(MainActivity.main, -1, -1,
					ContextCompat.getDrawable(MainActivity.main, R.drawable.notice));
		...
		HomeButton hbCreateProject = new HomeButton(MainActivity.main, R.drawable.create_proj, R.string.create_proj,
		...
		HomeButton hbCreateTempProject = new HomeButton(MainActivity.main, R.drawable.create_temp_proj,
				R.string.create_temp_proj, new View.OnClickListener() {
		...
		HomeButton hbCreateFile = new HomeButton(MainActivity.main, R.drawable.create_file, R.string.create_file,
				new View.OnClickListener() {
		...
		HomeButton hbExamples = new HomeButton(MainActivity.main, R.drawable.examples, R.string.example_proj,
				new View.OnClickListener() {
		...
		HomeButton hbRecent = new HomeButton(MainActivity.main, R.drawable.recent, R.string.recent_projs,
				new View.OnClickListener() {
