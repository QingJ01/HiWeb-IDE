...
public class ReviewElement
{
							...
							public void run()
							{
								try
								{
									...
									
									{
										...
										vBlTxt.descriptionTv.setText(vSText.length()>20 ? vSText.substring(0,21)+"..." : (vSText.length()==0 ? MainActivity.main.getString(R.string.review_element_no_texts) : vSText));
										...
										for(int i=0;i<vEsHead.size();i++)
										{
											...
											vBlChild.setOnLongClickListener(new View.OnLongClickListener(){
													...
													public boolean onLongClick(View p1)
													{
														...
														dl.builder.setTitle(MainActivity.main.getString(R.string.review_element_del_qu1)+vENow.tagName()+MainActivity.main.getString(R.string.review_element_del_qu2));
	...
	private void showChild(final Element input)
	{
		...
		AdReview.setButton(AlertDialog.BUTTON_NEUTRAL,MainActivity.main.getString(R.string.review_element_parent), new DialogInterface.OnClickListener(){
	...
	private void addChild(final Element input)
	{
		...
		vAdbNew.builder.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener(){
				...
				public void onClick(DialogInterface p1, int p2)
				{
					...
					Element vENew=new Element(Tag.valueOf(vTlTag.getText("$")),"file://"+MainActivity.main.getNowEpi().getFile().getParent(),attr);
	...
	private void showAttrs(final Element input)
	{
		...
		vAdbNew.builder.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener(){
				...
				public void onClick(DialogInterface p1, int p2)
				{
					...
					Element vENew=new Element(Tag.valueOf(input.tagName()),"file://"+MainActivity.main.getNowEpi().getFile().getParent(),attrs);
