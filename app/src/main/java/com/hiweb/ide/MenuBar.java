...
public class MenuBar extends LinearLayout
{
    ...
    public MenuBar(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr, int defStyleRes) 
	{
	...
	public void load(Object[][] menu,int color)
	{
		...
		for(Object[] nowMenu:menu)
		{
			...
			iconBtn=new IconButton(id,getContext(),(int) nowMenu[0],color,(int) nowMenu[1],(View.OnClickListener) nowMenu[2]);
	...
	{
		public IconButton(int id,final Context ctx,int drawable,int color,final int text,View.OnClickListener listen)
		{
			super(ctx);
