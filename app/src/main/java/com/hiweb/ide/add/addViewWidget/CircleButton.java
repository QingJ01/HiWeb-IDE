...
public class CircleButton extends RelativeLayout {
	...
	public void barMode() {
		...
		drawable.setTint(isImportantBtn ? Do.getColor(getContext(), R.color.pure)
				: Do.getColor(getContext(), R.color.opposition));
		...
		textView.setTextColor(isImportantBtn ? Do.getColor(getContext(), R.color.pure)
				: Do.getColor(getContext(), R.color.opposition));
		...
		setBackgroundDrawable(
				isImportantBtn ? ctx.getDrawable(R.drawable.circle_btn) : ctx.getDrawable(R.drawable.circle_ash_btn));
