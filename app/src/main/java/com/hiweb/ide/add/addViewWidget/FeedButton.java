...
public class FeedButton extends LinearLayout {
    ...
    public FeedButton(Context c, int name, int description, Drawable icon)
    {
        ...
        setPadding(Do.dp2px(getContext(),5), Do.dp2px(getContext(),5),Do.dp2px(getContext(),5),Do.dp2px(getContext(),5));
        setOrientation(LinearLayout.HORIZONTAL);
        setGravity(Gravity.CENTER|Gravity.LEFT);
        setBackground(getRippleDrawable(-1));
        setClickable(true);
        Do.setMargin(this,Do.dp2px(getContext(),10),Do.dp2px(getContext(),10),Do.dp2px(getContext(),10),Do.dp2px(getContext(),10));

        iv=new ImageView(c);
        iv.setLayoutParams(new LinearLayout.LayoutParams(Do.dp2px(getContext(),30),Do.dp2px(getContext(),30)));
        iv.setScaleType(ImageView.ScaleType.FIT_XY);
        iv.setImageDrawable(icon);
        Do.setMargin(iv,Do.dp2px(getContext(),10),Do.dp2px(getContext(),10),Do.dp2px(getContext(),10),Do.dp2px(getContext(),10));
        addView(iv);
    ...
    public void diminish(){
        setPadding(Do.dp2px(getContext(),10), Do.dp2px(getContext(),3),Do.dp2px(getContext(),10),Do.dp2px(getContext(),3));
    ...
    private RippleDrawable getRippleDrawable(int bgColor){
        ...
        RippleDrawable rippleDrawable = new RippleDrawable(ColorStateList.valueOf(bgColor),gradientDrawable,contentDrawable);
