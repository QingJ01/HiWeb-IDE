...
public class PHPServerReceiver {
                                        ...
                                        public void onClick(View p1) {
                                            try {
                                                ...
                                                if (Do.isServersHasPort(IPort)) {
                                                    Toast.makeText(MainActivity.main, R.string.server_wifi_port_has,
                                                ...
                                                try {
                                                    ...
                                                    Toast.makeText(MainActivity.main, R.string.server_set_done_toast,
                                                            Toast.LENGTH_SHORT).show();
                                                } catch (Exception e) {
                                                ...
                                                AdWifi.dismiss();
                                                Toast.makeText(MainActivity.main, R.string.server_set_err,
                                                        Toast.LENGTH_SHORT).show();
                                            }
    ...
    public static void putMapServer(final int IPort, File FProjectDir) {
        ...
        Vers.phpServerWebsitesMap.put(IPort,
                new Object[] { FProjectDir, LocalServersManager.getServerItem(1, IPort, FProjectDir) });
    }
                        ...
                        MainActivity.main.runOnUiThread(() -> {
                            ...
                            if (errorFile.exists()) {
                                try {
                                    ...
                                    try {
                                        ((LocalServersManager.ServerItem) (Vers.phpServerWebsitesMap
                                                .get(port)[1])).SAlert = errorMsg;
                                        ((LocalServersManager.ServerItem) (Vers.phpServerWebsitesMap.get(port)[1]))
                            ...
                            try {
                                ((LocalServersManager.ServerItem) (Vers.phpServerWebsitesMap
                                        .get(port)[1])).SAlert = MainActivity.main.getString(R.string.reconnecting);
                                ((LocalServersManager.ServerItem) (Vers.phpServerWebsitesMap.get(port)[1]))
                                        .setIcon(LocalServersManager.ServerItem.STATUS_ALERT);
                            } catch (Exception e) {
    ...
    public static void deleteWebsite(int port) {
        ...
        try {
            final LinearLayout parent = ((LinearLayout) (((ViewGroup) (Vers.phpServerWebsitesMap.get(port)[1]))
                    .getParent()));
