...
public class ServerNotification {
    ...
    public ServerNotification(Context ctx, int type) {
        ...
        mNotifyMgr = (NotificationManager) ctx.getSystemService(ctx.NOTIFICATION_SERVICE);
        ...
        builder
                ...
                .setContentTitle(
                        type == 0 ? ctx.getString(R.string.easyweb_server_on) : ctx.getString(R.string.php_server_on))
