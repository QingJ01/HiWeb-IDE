    ...
    private void main2() {
        if (!Vers.i.isNowProjectEnableServer) {
            ...
            switch (Vers.i.nowProjectServerType) {
                ...
                case 1:
                case 2:
                    LocalServersManager.showWebsiteDialog(MainActivity.main, Vers.i.nowProjectServerType,
                            Vers.i.nowWebsitePort);
                                ...
                                try {
                                    ...
                                    if (JoServer.has("handlers")) {
                                        ...
                                        for (int i = 0; i < JaHandlers.size(); i++) {
                                            MNow.put(JaHandlers.get(i).getAsJsonObject().get("path").getAsString(),
                                                    new Object[] {
                                                            new File(Vers.i.ProjectDir,
                                                                    JaHandlers.get(i).getAsJsonObject().get("file_path")
                                                                            .getAsString()),
                                                            JaHandlers.get(i).getAsJsonObject().get("file_type")
                                                                    .getAsInt() });
                                        }
