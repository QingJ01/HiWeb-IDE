...
public class EasyWebServerReceiver {
    ...
    public static void shutdownServer(Context c) {
        ...
        for (final int i : Vers.easyWebServerWebsitesMap.keySet()) {
            ...
            MainActivity.main.runOnUiThread(new Runnable() {
                ...
                public void run() {
                    try {
                        ((LocalServersManager.ServerItem) (Vers.easyWebServerWebsitesMap.get(i)[3]))
    ...
    public static void showRegManager(final int IPort) {
        ...
        Actv.setPadding(Do.dp2px(MainActivity.main, 10), Do.dp2px(MainActivity.main, 10),
                Do.dp2px(MainActivity.main, 10), Do.dp2px(MainActivity.main, 10));
        ...
        if (MNow.isEmpty()) {
            ...
            Adb.builder.setItems(SaPaths, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface p1, final int I) {
                    ...
                    TlFile.Acet.setText(FLink.getPath()
                            .replace(((File) ((Vers.easyWebServerWebsitesMap.get(IPort))[1])).getPath() + "/", ""));
                    ...
                    AdbBuilder.builder.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface p1, int p2) {
                            ...
                            try {
                                ...
                                File FNewFile = new File(
                                        ((File) ((Vers.easyWebServerWebsitesMap.get(IPort))[1])).getPath() + "/"
                                                + SNewFile);
                                if (!SNewPath.equals(SPath) && (MNow.containsKey(SNewPath)) || !FNewFile.exists()
                                        || FNewFile.isDirectory()) {
                    ...
                    AdbBuilder.builder.setNeutralButton(R.string.main_explorer_delete,
                ...
                AdbBuilder.builder.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface p1, int p2) {
                        ...
                        try {
                            String SNewPath = TlPath.getText("$");
                            String SNewFile = TlFile.getText("$");
                            File FNewFile = new File(((File) ((Vers.easyWebServerWebsitesMap.get(IPort))[1])).getPath()
                                    + "/" + SNewFile);
    ...
    public static void saveHandlerManifest(String SNewPath, File FNewFile, int IPort) throws Exception {
...

        {
            ...
            if (Vers.i.nowHWPPath == null) {
                Vers.i.nowHWPPath = new File(((File) ((Vers.easyWebServerWebsitesMap.get(IPort))[1])).getPath(),
                        "manifest.json");
    ...
    private static JsonArray getHandlerArray(int IPort) {
        ...
        for (Object SPath : MNow.keySet()) {
            ...
            String SFilePath = ((File) ((Object[]) (MNow.get(SPath)))[0]).getPath()
                    .replace(((File) ((Vers.easyWebServerWebsitesMap.get(IPort))[1])).getPath() + "/", "");
    ...
    public static void deleteWebsite(boolean isShutdownServer, int port) {
        ...
        try {
            final LinearLayout parent = ((LinearLayout) (((ViewGroup) (Vers.easyWebServerWebsitesMap.get(port)[3]))
                    .getParent()));
        ...
        try {
            if (Vers.isServerOn) {
                ((LocalServersManager.ServerItem) (Vers.easyWebServerWebsitesMap.get(port)[3]))
                        .setIcon(isOpen ? LocalServersManager.ServerItem.STATUS_RUNNING
                                : LocalServersManager.ServerItem.STATUS_OFF);
                if (isOpen) {
                    // 启用
                ...
                try {
                    ...
                    MainActivity.main.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            ClForm.build(false, 2, null, R.string.server_wifi_website_form,
                                    MainActivity.main.getString(R.string.server_wifi_website_form_page) + "|"
                                            + MainActivity.main.getString(R.string.server_wifi_website_form_explorer));
                            Ly.addView(ClForm);
                            ...
                            AdWifi.show();
                            AdWifi.getButton(AlertDialog.BUTTON_POSITIVE)
                                    .setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View p1) {
                                            try {
                                                ...
                                                if (SType.equals(MainActivity.main
                                                        .getString(R.string.server_wifi_website_form_page))) {
                                                    BIsWebsite = true;
                                                } else if (SType.equals(MainActivity.main
                                                        .getString(R.string.server_wifi_website_form_explorer))) {
                                                    BIsWebsite = false;
                                                } else {
                                                    throw new Exception();
                                                }
    ...
    public static void saveSetting(int IPort, boolean BIsWebsite, boolean isHttps, File FProjectDir)
            throws IOException {
    ...
    public static void putMapServer(final int IPort, boolean BIsWebsite, boolean isHttps, File FProjectDir) {
        ...
        Vers.easyWebServerWebsitesMap.put(IPort, new Object[] { BIsWebsite, FProjectDir, isHttps,
                LocalServersManager.getServerItem(0, IPort, FProjectDir) });
    }
