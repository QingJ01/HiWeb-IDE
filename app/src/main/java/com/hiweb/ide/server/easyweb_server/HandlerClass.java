            ...
            switch(IType)
            {
                case 0:
                {
                    ...
                    MainActivity.main.runOnUiThread(new Runnable(){
                        ...
                        @Override
                        public void run() {
                            Jr.run(Do.WccJSSRunner,MainActivity.main,SCode,((File)((Vers.easyWebServerWebsitesMap.get(IPort))[1])),params,res,IPort,SPath,FLink.getPath().replace(((File)((Vers.easyWebServerWebsitesMap.get(IPort))[1])).getPath()+"/",""));
                        }
                    });
