...
public class ErrorActivity extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		try
		{
			...
			errorMsg=("Brand:"+mtyb+"\nModel:"+mtype+"\nOS Version:"+OSVersion+"|"+OSVersionSDK+"\nApplication Version:"+(getPackageManager().
				getPackageInfo(getPackageName(), 0).versionName)+"|"+(getPackageManager().
        ...
        binding.btnErrClose.setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View p1) {
                    ClipboardManager cmb = (ClipboardManager)ErrorActivity.this.getSystemService(Context.CLIPBOARD_SERVICE);  
