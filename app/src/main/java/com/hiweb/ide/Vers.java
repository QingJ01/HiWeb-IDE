...
public class Vers {
	...
	public final File userFile = new File(Environment.getExternalStorageDirectory().getPath() + "/" + "Venter",
			"user_info.json");
	public File FVenter;
	...
	public Object[][] OaAdd = new Object[][] {
			...
			{ R.string.add_em_a, "<a>", new Object[][] {
					...
					{ R.string.add_a_rel, "Rel", 4,
							"alternate|stylesheet|start|next|prev|contents|index|glossary|copyright|chapter|section|subsection|appendix|help|bookmark|nofollow|licence|tag|friend",
							"rel=\"$\"" }
			}, "<a $></a>" },
			...
			{ R.string.add_em_style_text, "<h1>-<h6>,<del>,<em>...", new Object[][] {
					{ R.string.add_text_style, "Format", 5,
							"abbr|b|bdi|bdo|blockquote|cite|code|del|dfn|em|h1|h2|h3|h4|h5|h6|i|ins|kbd|mark|meter|nobr|pre|progress|q|rp|rt|ruby|s|samp|small|strike|strong|sub|sup|time|u|var|wbr",
							"$" }
			}, "<$>" },
			...
			{ R.string.add_em_meta, "<meta>", new Object[][] {
					...
					{ R.string.add_meta_http_equiv, "Http-Equiv", 4, "content-type|default-style|refresh",
							"http-equiv=\"$\"" },
					{ R.string.add_meta_name, "Name", 4,
							"application-name|author|description|generator|keywords|theme-color|viewport",
							"name=\"$\"" }
			}, "<meta $/>" },
			// 8↑
			{ R.string.add_link, "<link>", new Object[][] {
					...
					{ R.string.link_rel, "Rel", 5,
							"alternate|author|help|icon|shortcut icon|licence|next|pingback|prefetch|prev|search|sidebar|stylesheet",
							"rel=\"$\"" },
	...
	public Object[][] OaAddJS = new Object[][] {
			...
			{ R.string.add_js_create_em,
					"document.getElementById( string_id ).parentNode.appendChild(document.createElement( string_element ));" },
			{ R.string.add_js_remove_em,
					"document.getElementById( string_id ).parentNode.removeChild(document.getElementById( string_id ));" },
	...
	public Object[][] OaAddJSSFile = new Object[][] {
			...
			{ R.string.add_jss_file_create_dir,
					"File.newFile( string_dirPath ).createDir( boolean_canMakePathDirs );" },
	...
	public Object[][] jsPackNames = {
			...
			{ "window", new String[] {
					"frames[]", "closed", "defaultStatus", "document", "history", "innerheight", "innerwidth", "length",
					"location", "name", "Navigator", "opener", "outerheight", "outerwidth", "pageXOffset",
					"pageYOffset", "parent", "Screen",
					"self", "status", "top", "window", "screenLeft", "screenTop", "screenX", "screenY",

					"alert()", "blur()", "clearInterval()", "clearTimeout()", "close()", "confirm()", "createPopup()",
					"focus()", "moveBy()", "moveTo()", "open()", "print()",
					"prompt()", "resizeBy()", "resizeTo()", "scrollBy()", "scrollTo()", "setInterval()", "setTimeout()"
			} },
			{ "navigator", new String[] {
					"plugins[]", "appCodeName", "appMinorVersion", "appName", "appVersion", "browserLanguage",
					"cookieEnabled", "cpuClass", "onLine", "platform",
					"systemLanguage", "userAgent", "userLanguage",

					"javaEnabled()", "taintEnabled()"
			} },
			{ "screen", new String[] {
					"availHeight", "availWidth", "bufferDepth", "colorDepth", "deviceXDPI", "deviceYDPI",
					"fontSmoothingEnabled", "height", "logicalXDPI", "logicalYDPI", "pixelDepth", "updateInterval",
					"width"
			} },
			{ "history", new String[] {
			...
			{ "document", new String[] {
					...
					"close()", "getElementById()", "getElementsByName()", "getElementsByTagName()", "open()", "write()",
					"writeln()"
			} },
			{ "JSON", new String[] {
					"stringify()", "parse()"
			...
			{ "console", new String[] {
					"log()", "clear()", "assert()", "count()", "error()", "group()", "groupCollapsed()", "groupEnd()",
					"info()", "table()", "time()", "timeEnd()", "trace()", "warn()", "debug()"
			} },
	};
