...
public class SettingDoor
{
    ...
    public static void show()
    {
        ...
        Acib.setLayoutParams(new LinearLayout.LayoutParams(Do.dp2px(MainActivity.main,44),Do.dp2px(MainActivity.main,44)));
        ...
        ClTheme.build(true,-1,MainActivity.main.getString(R.string.set_theme),R.string.need_reboot,MainActivity.main.getString(R.string.set_theme_blue)+"|"+MainActivity.main.getString(R.string.set_theme_black)+"|"+MainActivity.main.getString(R.string.set_theme_green)+"|"+MainActivity.main.getString(R.string.set_theme_light)+"|"+MainActivity.main.getString(R.string.set_theme_white));
        ...
        ClDarktheme.build(false,-1,MainActivity.main.getString(R.string.set_darktheme),R.string.need_reboot,MainActivity.main.getString(R.string.enable)+"|"+MainActivity.main.getString(R.string.disable));
		...
		LyJsRes.setPadding(Do.dp2px(MainActivity.main,10),Do.dp2px(MainActivity.main,10),Do.dp2px(MainActivity.main,10),Do.dp2px(MainActivity.main,10));
		...
		LyPhpIni.setPadding(Do.dp2px(MainActivity.main,10),Do.dp2px(MainActivity.main,10),Do.dp2px(MainActivity.main,10),Do.dp2px(MainActivity.main,10));
		...
		TlBackup.build(-1,MainActivity.main.getString(R.string.backup_frequency),R.string.backup_frequency_describe,null);
        ...
        ClWordWarp.build(false,-1,null,R.string.wordwarp,MainActivity.main.getString(R.string.enable)+"|"+MainActivity.main.getString(R.string.disable));
        ...
        ClAllowAbsolute.build(false,-1,MainActivity.main.getString(R.string.allow_use_absolute_path),R.string.allow_use_absolute_path_des,MainActivity.main.getString(R.string.enable)+"|"+MainActivity.main.getString(R.string.disable));
		...
		LyQs.setPadding(Do.dp2px(MainActivity.main,10),Do.dp2px(MainActivity.main,10),Do.dp2px(MainActivity.main,10),Do.dp2px(MainActivity.main,10));
								...
								if(ChooseFile.getName().toLowerCase().endsWith(".zip"))
								{
									...
									Do.showWaitAndRunInThread(false, new Runnable(){
											...
											public void run()
											{
												try
												{
													final File website=new File(MainActivity.main.getFilesDir(),"custom_quickstart");
													if(website.exists())
													{
													...
													{
														throw new Exception("The selected ZIP file can't be used. Maybe there are some errors in this file.");
													}
        ...
        ClAutoPreviewFull.build(false,-1,null,R.string.auto_preview_full,MainActivity.main.getString(R.string.enable)+"|"+MainActivity.main.getString(R.string.disable));
        ...
        ClHideHW.build(false,-1,MainActivity.main.getString(R.string.hide_hopweb),R.string.apply_in_a_few_time,MainActivity.main.getString(R.string.enable)+"|"+MainActivity.main.getString(R.string.disable));
        ...
        ClShowWebViewAlert.build(false,-1,null,R.string.show_webview_alert,MainActivity.main.getString(R.string.enable)+"|"+MainActivity.main.getString(R.string.disable));
                    ...
                    {
                        {
                            ...
                            {
                                SaChars=TlChars.getText("$")==null?new String[]{}:TlChars.getText("$").trim().split(" ");
                            }
                            ...
                            {
                                SaNames=TlNames.getText("$")==null?new String[]{}:TlNames.getText("$").trim().split(" ");
                            }
							...
							boolean vBIsDarktheme=ClDarktheme.getText("$").equals(MainActivity.main.getString(R.string.enable));
							...
							SettingsClass.isAutoPreviewFull=ClAutoPreviewFull.getText("$").equals(MainActivity.main.getString(R.string.enable));

							SettingsClass.isAllowAbsolute=ClAllowAbsolute.getText("$").equals(MainActivity.main.getString(R.string.enable));

							SettingsClass.isHideHW=ClHideHW.getText("$").equals(MainActivity.main.getString(R.string.enable));

							SettingsClass.isShowWebViewAlert=ClShowWebViewAlert.getText("$").equals(MainActivity.main.getString(R.string.enable));
	...
	{
		{Vers.i.serverHost+"server/easyweb/jsres/jquery/latest_ver.txt",new String[]{Vers.i.serverHost+"server/easyweb/jsres/jquery/prod.js", Vers.i.serverHost+"server/easyweb/jsres/jquery/dev.js"},
			MainActivity.main.getString(R.string.jquery),MainActivity.main.getResources().getDrawable(R.drawable.jquery),MainActivity.main.getString(R.string.jquery_ad),
			"https://jquery.com",MainActivity.main.getString(R.string.installation_ad)},//jQuery 0
		{Vers.i.serverHost+"server/easyweb/jsres/vuejs/latest_ver.txt",new String[]{Vers.i.serverHost+"server/easyweb/jsres/vuejs/prod.js",null},
			MainActivity.main.getString(R.string.vuejs),MainActivity.main.getResources().getDrawable(R.drawable.vuejs),MainActivity.main.getString(R.string.vue_ad),
			"https://cn.vuejs.org",MainActivity.main.getString(R.string.installation_ad)},//Vue.js 1
		{Vers.i.serverHost+"server/easyweb/jsres/mui/latest_ver.txt",null,
			MainActivity.main.getString(R.string.mui),MainActivity.main.getResources().getDrawable(R.drawable.mui),MainActivity.main.getString(R.string.mui_ad),
			"https://dev.dcloud.net.cn/mui",MainActivity.main.getString(R.string.installation_ad_lib),MUIManager.class},//MUI 2
		{Vers.i.serverHost+"server/easyweb/jsres/vconsole/latest_ver.txt",new String[]{Vers.i.serverHost+"server/easyweb/jsres/vconsole/prod.js",null},
			MainActivity.main.getString(R.string.vconsole),MainActivity.main.getResources().getDrawable(R.drawable.vconsole),MainActivity.main.getString(R.string.vconsole_ad),
			"https://github.com/Tencent/vConsole",MainActivity.main.getString(R.string.installation_ad)},//vConsole 3
		{Vers.i.serverHost+"server/easyweb/jsres/mdui/latest_ver.txt",null,
			MainActivity.main.getString(R.string.mdui),MainActivity.main.getResources().getDrawable(R.drawable.layers),MainActivity.main.getString(R.string.mdui_ad),
			"https://www.mdui.org/",MainActivity.main.getString(R.string.installation_ad_lib),MDUIManager.class},//MDUI 4
		{Vers.i.serverHost+"server/easyweb/jsres/bootstrap/latest_ver.txt",null,
			MainActivity.main.getString(R.string.bootstrap),MainActivity.main.getResources().getDrawable(R.drawable.bootstrap),MainActivity.main.getString(R.string.bootstrap_ad),
			"https://getbootstrap.com/",MainActivity.main.getString(R.string.installation_ad_lib),BootstrapManager.class},//Bootstrap 5
		{Vers.i.serverHost+"server/easyweb/jsres/art-template/latest_ver.txt",new String[]{Vers.i.serverHost+"server/easyweb/jsres/art-template/prod.js",null},
			MainActivity.main.getString(R.string.art_template),MainActivity.main.getResources().getDrawable(R.drawable.art_template),MainActivity.main.getString(R.string.art_template_ad),
			"http://aui.github.io/art-template/",MainActivity.main.getString(R.string.installation_ad)},//art-template 6
		{Vers.i.serverHost+"server/easyweb/jsres/layui/latest_ver.txt",null,
			MainActivity.main.getString(R.string.layui),MainActivity.main.getResources().getDrawable(R.drawable.layui),MainActivity.main.getString(R.string.layui_ad),
			"https://www.layuiweb.com/",MainActivity.main.getString(R.string.installation_ad_lib),LayuiManager.class}//Layui 7
								...
								for(int i=0;i<jsLinkArr.length;i++)
								{
									...
									bl.setOnClickListener(new View.OnClickListener(){
											...
											public void onClick(View p1)
											{
												...
												jsResLy.setBackground(MainActivity.main.getResources().getDrawable(R.drawable.shape_gray_background));
												jsResLy.setPadding(Do.dp2px(MainActivity.main,10),Do.dp2px(MainActivity.main,10),Do.dp2px(MainActivity.main,10),Do.dp2px(MainActivity.main,10));
												...
												Adb.builder.setPositiveButton(R.string.download_or_update, (p11, p2) -> {
													if(jsLinkArr[index][1]==null)
													{
														//下载库
														try {
															((LibraryManager) ((Class) jsLinkArr[index][7]).newInstance()).download(verArr[index]);
													...
													ly1.setPadding(Do.dp2px(MainActivity.main,10),Do.dp2px(MainActivity.main,10),Do.dp2px(MainActivity.main,10),Do.dp2px(MainActivity.main,10));
													ly1.setOrientation(LinearLayout.VERTICAL);
													Rl1.addView(ly1);
													Sv1.addView(Rl1);

													Drawable dDown=MainActivity.main.getResources().getDrawable(R.drawable.download);
													...
													AdbDown.builder.setTitle(MainActivity.main.getString(R.string.download)+" "+name);
													AdbDown.builder.setView(Sv1);
													AdbDown.builder.setPositiveButton(R.string.cancel,null);
													AdbDown.show();
												});
												Adb.builder.setNeutralButton(R.string.js_website, new DialogInterface.OnClickListener(){
				...
				if(myJsresJsonObject.has(jsLinkArr[i][2].toString()))
				{
					...
					*/
					if(nowJsresVers.has("prod"))
						sbVers.append(MainActivity.main.getString(R.string.prod)+nowJsresVers.get("prod").getAsString());
					if(nowJsresVers.has("dev"))
						sbVers.append((nowJsresVers.has("prod") ? "\n" : "")+MainActivity.main.getString(R.string.dev)+nowJsresVers.get("dev").getAsString());
					ButtonLayout bl=new ButtonLayout(MainActivity.main);
					...
					bl.setOnClickListener(new View.OnClickListener(){
							...
							public void onClick(View p1)
							{
								...
								if(nowJsresVers.has("prod"))
								{
									...
									bl.titleTv.setText(MainActivity.main.getString(R.string.prod)+nowJsresVers.get("prod").getAsString());
								...
								if(nowJsresVers.has("dev"))
								{
									ButtonLayout bl=new ButtonLayout(MainActivity.main);
									bl.leftImg.setVisibility(View.GONE);
									bl.titleTv.setText(MainActivity.main.getString(R.string.dev)+nowJsresVers.get("dev").getAsString());
									bl.descriptionTv.setText(R.string.jsres_touch_del);
									bl.setOnClickListener(new View.OnClickListener(){
	...
	{
		Do.showImgDialogCust(MainActivity.main, MainActivity.main.getString(R.string.jsres_help1_title), R.string.jsres_help1_msg, R.drawable.jsres_1, R.string.next, new DialogInterface.OnClickListener(){

				@Override
				public void onClick(DialogInterface p1, int p2)
				{
					Do.showImgDialog(MainActivity.main,R.string.jsres_help2_title,R.string.jsres_help2_msg,R.drawable.jsres_2);
				}
			}, false);
	}
					...
					if(myJsresJsonObject.has(jsLinkArr[i][2].toString()))
					{
						...
						bl.setOnClickListener(new View.OnClickListener(){
								...
								public void onClick(View p1)
								{
									Ad.dismiss();
									Dl AdbManagerSelectedJsres=new Dl(MainActivity.main);
									AdbManagerSelectedJsres.builder.setTitle(MainActivity.main.getString(R.string.choose)+" "+name);
									final AlertDialog Ad=AdbManagerSelectedJsres.create();
	...
	public static void regJsresProject()
	{
		...
		if(MainActivity.main.binding.Ep.MSID.size()>0)
		{
			...
			{
				if(((EditorPage.EPItem)(((Object[])(MainActivity.main.binding.Ep.MSID.get(IKey)))[0])).getFile().getName().toLowerCase().endsWith(".html"))
				{
					vMOpenFile.put(((EditorPage.EPItem)(((Object[])(MainActivity.main.binding.Ep.MSID.get(IKey)))[0])).getFile(),(Editor)(((Object[])(MainActivity.main.binding.Ep.MSID.get(IKey)))[1]));
				}
			}
		}
							...
							public void run()
							{
								try
								{
									...
									for(final Object now:allHTMLFileList)
									{
										...
										String path=new File(((File) now).getPath().replace(Vers.i.ProjectDir.getPath()+"/","")).getPath();
										if(path.indexOf("/")==-1)
										{
									...
									MainActivity.main.runOnUiThread(new Runnable(){
											...
											{
												Do.finishWaiting();
												MainActivity.main.binding.elvMainExplorerFile.toExplorer(new File(Vers.i.ProjectDir.getPath()+ Vers.i.ExplorerPath));
												Dl dl=new Dl(MainActivity.main);
    ...
    public static void showAbout()
    {
		...
		try
        {
            TvVer.setText(MainActivity.main.getPackageManager().
